...
public class LevelTrans2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        GameObject[] remainingPellets = GameObject.FindGameObjectsWithTag("red");
        GameObject[] remainingPellets2 = GameObject.FindGameObjectsWithTag("blue");
        int remaining = remainingPellets.Length + remainingPellets2.Length;
